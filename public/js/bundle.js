...
var displayMap = function displayMap(coordinates) {
  ...
  coordinates.forEach(function (loc) {
    // Add a marker
...
var updatePassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(currentPassword, newPassword, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KaHVzSDqwWVy43NBxhDbTVe84LQr01cCGVTVcA1ed1F34aDc9GXmiRH8Bb4h8t4YSIMuFXY6B2L6hgP42ofQXNo004lX1x5di'); // 1> get the checkout session from the server;
...
if (mapBox) {
  var coordinates = JSON.parse(mapBox.getAttribute('data-locations'));
  (0, _mapbox.displayMap)(coordinates);
}
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updatePassword.updatePassword)(currentPassword, newPassword, passwordConfirm);
  });
}
